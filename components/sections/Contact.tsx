        ...
        <motion.div initial={{opacity:0,y:25}} whileInView={{opacity:1,y:0}} viewport={{once:true}}
          ...
          <div className="relative">
            ...
            <Button size="lg" asChild className="mb-10">
              <a href="mailto:silderdevprofissional07@gmail.com?subject=Quero%20conversar%20sobre%20uma%20solu%C3%A7%C3%A3o"><MessageCircle className="h-5 w-5 mr-2"/>Falar com Caio</a>
            </Button>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-5 text-sm text-muted-foreground">
              <a className="flex items-center gap-2 hover:text-foreground" href="mailto:silderdevprofissional07@gmail.com"><Mail className="h-4 w-4"/>silderdevprofissional07@gmail.com</a>
